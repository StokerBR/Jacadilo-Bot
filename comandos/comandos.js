    ...
    executar(mensagem, gerenciadorErros, mensagemMinusculo, arg, discord, bot, prefixo, versão, hmm){
        try{
            if(!arg[1]){
                ...
                embed.addField(`**Comandos:**`, '``análise``, ``apague``, ``cante``, ``chame``, ``comandos``, ``crie chamada``, ``dance``, ``entre``, ``imagem``, ``imite``, ``info``, ``jacadilo``, ``nego ney``, ``oi``, ``quantidade``, ``saia``, ``spam``, ``vídeo``');
