    ...
    executar(mensagem, gerenciadorErros, mensagemMinusculo, arg, discord, bot, prefixo, versão, hmm){
        try{
            if(!arg[1]){
                ...
                embed.addField(`**Comandos:**`, '``análise``, ``apague``, ``buzzfeed``, ``cante``, ``calado``, ``chame``, ``comandos``, ``copypaste``, ``dance``, ``entre``, ``furry``, ``imagem``, ``imite``, ``info``, ``jacadilo``, ``nego ney``, ``oi``, ``quantidade``, ``reinicie``, ``saia``, ``spam``, ``vídeo``');
